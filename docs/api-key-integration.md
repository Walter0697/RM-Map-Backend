...
- Response includes:
  ...
  - `today_schedule_items_count`: number of schedules for the current local date (filtered by selected-date range and marker timezone), before reminder-window filtering.
